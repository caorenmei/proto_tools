describe("bean_utils.plain", function()
    ...
    describe("set_field", function()
        it("设置新值成功，返回 true", function()
            ...
            local result = plain.set_field(self, 2, "hello", assertion.assert_string)
        ...
        it("设置相同值返回 false", function()
            local self = make_self()
            plain.set_field(self, 2, "hello", assertion.assert_string)
            local result = plain.set_field(self, 2, "hello", assertion.assert_string)
        ...
        it("断言失败时抛出错误", function()
            ...
            assert.has_error(function()
                plain.set_field(self, 2, 123, assertion.assert_string)
    ...
    describe("oneof operations", function()
        describe("set_oneof_field", function()
            it("设置值", function()
                local self = make_self()
                local result = plain.set_oneof_field(self, 2, 1, "hello", assertion.assert_string)
                assert.is_true(result)
            ...
            it("相同值返回 false", function()
                local self = make_self()
                plain.set_oneof_field(self, 2, 1, "hello", assertion.assert_string)
                local result = plain.set_oneof_field(self, 2, 1, "hello", assertion.assert_string)
                assert.is_false(result)
            end)
            ...
            it("断言失败时抛出错误", function()
                local self = make_self()
                assert.has_error(function()
                    plain.set_oneof_field(self, 2, 1, 123, assertion.assert_string)
                end, "value must be a string")
            end)
        end)
    ...
    describe("repeated value operations", function()
        describe("add_repeated_value", function()
            it("添加值", function()
                local self = make_self()
                plain.add_repeated_value(self, 2, "a", assertion.assert_string)
                plain.add_repeated_value(self, 2, "b", assertion.assert_string)
            ...
            it("断言失败时抛出错误", function()
                local self = make_self()
                assert.has_error(function()
                    plain.add_repeated_value(self, 2, 123, assertion.assert_string)
                end, "value must be a string")
            end)
        end)
        ...
        describe("set_repeated_value", function()
            it("修改值", function()
                ...
                plain.add_repeated_value(self, 2, "a", assertion.assert_string)
                plain.add_repeated_value(self, 2, "b", assertion.assert_string)
                plain.set_repeated_value(self, 2, 1, "x", assertion.assert_string)
            ...
            it("设置相同值不修改", function()
                local self = make_self()
                plain.add_repeated_value(self, 2, "a", assertion.assert_string)
                plain.set_repeated_value(self, 2, 1, "a", assertion.assert_string)
            ...
            it("越界报错", function()
                ...
                plain.add_repeated_value(self, 2, "a", assertion.assert_string)
                assert.has_error(function()
                    plain.set_repeated_value(self, 2, 2, "x", assertion.assert_string)
                end, "index out of range")
                assert.has_error(function()
                    plain.set_repeated_value(self, 2, 0, "x", assertion.assert_string)
                end, "index out of range")
            end)
        end)
        ...
        describe("set_map_value", function()
            it("设置值", function()
                ...
                plain.set_map_value(self, 2, "k1", "v1", function(k, v)
                    assertion.assert_string(k)
                    assertion.assert_string(v)
                end)
                assert.equals(1, self[2])
